...
land10m_sf <- readRDS("../Data/RData/Land10M.rds")
...
sardist_sf <- st_read("../Data/NaturalResources/Species/SpeciesAtRisk/clipped_layers/sardist_4326.shp")
RVCatch_sf <-  SelectRV_fn(SurveyPrefix, File, minYear)
ClippedCritHab_sf <- st_read("../Data/NaturalResources/Species/SpeciesAtRisk/clipped_layers/ClipCritHab.shp")
...
save(Blue_Whale_sf, ClippedCritHab_sf, EBSA_sf, fin_whale, 
...
land50k_sf<-st_read("../Data/Boundaries/Coast50K/Coastline50k_SHP/Land_AtlCanada_ESeaboardUS.shp", quiet=TRUE)
getwd()
...
land10m <- st_read("N:/MSP/Data/Boundaries/Landmass/ne_10m_land_Clip.shp")
