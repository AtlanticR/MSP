---
title: "Port Hawkesbury Oil Spill Exercise"
...
Coastal areas are generally not adequately sampled on spatial and temporal scales of most relevance to oil spill incidents, i.e. tens to hundreds of meters and hours to months, and hence information on these space and time scales is generally not contained within the various data sources available to DFO, including the surveys referred to in this document. Therefore, there is uncertainty as to the exact distribution of species in the area of the proposed expansion.
