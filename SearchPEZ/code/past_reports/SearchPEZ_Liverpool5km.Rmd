---
title: "SearchPEZ in Liverpool"
author: Synthesis prepared for the CSAS Aquaculture Siting Review by the MSP Science Team
...
kable(marfis_freq) %>%
  kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
```
Map below shows the location of samples recorded in the MARFIS and ISDB databases (records are summarized in the tables/sections above). The yellow polygon shows the locations of the aquaculture site. The blue polygon displays the PEZ used for this synthesis. Records were cropped to match PEZ.
