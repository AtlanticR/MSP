...
```{r echo=FALSE, results='asis', caption="Priority species with observations contained in the iNaturalist database within the search polygon area."}
INAT_query_output_table<-if(x < 1){
  ""
} else {
  kable(inat_table4, row.names = F, fig.cap="Map showing the defined Potential Exposure Zone (PEZ; blue) and proposed project polygon (yellow) with iNaturalist records shown as black points.") %>%
    kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
