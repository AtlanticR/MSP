...
Report_isdb<-if(x < 1){
    "There are no records of Species at Risk in MARFIS for this polygon."
  } else {
    "There are records of Species at Risk in MARFIS for this polygon."
}
```
...
#site_map(PEZ_poly,PEZ_poly_st,site,land,2)
