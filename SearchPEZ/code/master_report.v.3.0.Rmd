...
Landshp <- st_read("../../../Data/Boundaries/Land50k_Maritimes.shp", quiet=TRUE)
...
plot_crithab(ClippedCritHab, PEZ_poly_st, Landshp)
```
...
plot_crithab_zoom(ClippedCritHab, PEZ_poly_st, Landshp)
```
