...
OBIS_query_output_table<-if(x < 1){
  ...
  kable(obis_table4, row.names = F, caption="Species at Risk with observations contained in the OBIS database within the search polygon area.") %>%
    kable_styling(bootstrap_options = "striped", full_width = F, position = "left")
}
...
## **Sea Turtle Section**
```{r Set up paths for leatherback turtle files, include=FALSE, cache=FALSE}
