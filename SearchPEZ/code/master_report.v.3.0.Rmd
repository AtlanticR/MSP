...
isdb_setcounttable<-data.frame(Common_Name="", Scientific_Name_upper="", SARA_listing="", COSEWIC_listing="", Wild_Species_listing="")
...
```{r}
isdb_set_summary_table<-data.frame(Organisms_recorded_in_polygon="", Listed_organisms_recorded_in_polygon="")
...
```{r}
isdb_table<-merge(isdb_setcounttabledf, listed_species, by='Scientific_Name_upper')
isdb_table2<-isdb_table %>% 
  transmute(Scientific_Name, Common_Name.y, Schedule.status, COSEWIC.status, Wild_Species)
