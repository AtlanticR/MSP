...
EBSA_overlap(EBSA_shp=EBSA, PEZ_poly_st= PEZ_poly_st)
```

```{r echo=FALSE, results='asis'}
#function for report
EBSA_report(EBSA_shp=EBSA, PEZ_poly_st= PEZ_poly_st)
```

```{r echo=FALSE, results='asis'}
#function for report url
EBSA_reporturl(EBSA_shp=EBSA, PEZ_poly_st= PEZ_poly_st)
```

```{r echo=FALSE, results='asis'}
#function for location
EBSA_location(EBSA_shp=EBSA, PEZ_poly_st= PEZ_poly_st)
```

```{r echo=FALSE, results='asis'}
#function for bioregion
EBSA_bioregion(EBSA_shp=EBSA, PEZ_poly_st= PEZ_poly_st)
```
...
plot_EBSA(EBSA, PEZ_poly_st, land_sf)
```
