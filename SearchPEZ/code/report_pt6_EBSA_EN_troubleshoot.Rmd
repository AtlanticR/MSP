...
EBSA_overlap(EBSA_sf, PEZ_poly_sf)
```

```{r echo=FALSE, results='asis'}
#function for report
EBSA_report(EBSA_sf, PEZ_poly_sf)
```

```{r echo=FALSE, results='asis'}
#function for report url
EBSA_reporturl(EBSA_sf, PEZ_poly_sf)
```

```{r echo=FALSE, results='asis'}
#function for location
EBSA_location(EBSA_sf, PEZ_poly_sf)
```

```{r echo=FALSE, results='asis'}
#function for bioregion
EBSA_bioregion(EBSA_sf, PEZ_poly_sf)
```
...
plot_EBSA(EBSA_sf, PEZ_poly_sf, land_sf, 300)
```
