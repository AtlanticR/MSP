---
title: "Search Species in PEZ - Master Report"
...
This report was prepared by the MSP team for use in supporting a request Request for Review form for the Amitié Submarine Cable System Project. A polygon surrounding the potential submarine cable (Predicted Exposure Zone: PEZ) was used to search regional databases (**2002 - 2018**) and summarize species that have been recorded. Species lists generated in this synthesis were subsequently circulated to staff in CSAS Maritimes Science to verify and compliment the information provided (e.g. spatial and temporal presence/absence of species in the area). 

Map below shows the PEZ polygon (blue) used to search regional databases and summarize recorded species.

NOTE FOR DEVELOPMENT: WOULD BE IDEAL TO USE CSASDOWN FOR INTERNAL RPEORTING FORMATTING 
