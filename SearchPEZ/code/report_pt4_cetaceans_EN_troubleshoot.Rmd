...
wsdb_plot<-site_map(PEZ_poly,PEZ_poly_st,site_sf,land_sf,5)+
...
intersect_narwc <- st_intersection(narwc_sf,PEZ_poly_st)
...
par(mfrow = c(1,2), mar=c(0, 0, 5.5, 0) + 2)#it goes c(bottom, left, top, right)
narwc_plot<-site_map(PEZ_poly,PEZ_poly_st,site_sf,land_sf,5)+
