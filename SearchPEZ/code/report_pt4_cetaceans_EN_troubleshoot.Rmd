...
inat<-read.csv("../../../Data/NaturalResources/Species/OBIS_GBIF_iNaturalist/iNaturalist_MAR_priority_records.csv")
...
```{r echo=FALSE, results='asis'}
#function for overlap
BW<-blue_whale_habitat_overlap(Blue_4326b, PEZ_poly_sf)
writeLines(BW)
```

```{r echo=FALSE, results='asis'}
#function for sector
blue_whale_habitat_sector(Blue_4326b, PEZ_poly_sf)
```

```{r echo=FALSE, results='asis'}
#function for activity
blue_whale_habitat_activity(Blue_4326b, PEZ_poly_sf)
```

```{r echo=FALSE, results='asis'}
#function for months
blue_whale_habitat_months(Blue_4326, PEZ_poly_sf)
```
