...
wsdb_intersect_points <-intersect_points_wsdb(wsdb_filter, PEZ_poly_sf)
wsdb_table <- table_wsdb(wsdb_filter, PEZ_poly_sf)
...
narwc_intersect_points <-intersect_points_narwc(narwc_filter, PEZ_poly_sf)
narwc_table <- table_narwc(narwc_filter, PEZ_poly_sf)
...
obis_intersect_points <-intersect_points_obis(obis_filter, PEZ_poly_sf)
obis_whale_table <- table_obis(obis_filter, PEZ_poly_sf)
