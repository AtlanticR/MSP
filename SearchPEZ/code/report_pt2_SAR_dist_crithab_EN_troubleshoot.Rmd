...
intersect_dist <- st_intersection(sardist_sf,PEZ_poly_sf)
...
*
```{r echo=FALSE, results='asis'}
crit_intersect <- st_intersection(ClippedCritHab_sf,PEZ_poly_sf)
...
leatherback_intersect <- st_intersection(leatherback_sf,PEZ_poly_sf)
...
```{r echo=FALSE, results='asis'}
sardist_wide<-plot_sardist(sardist_sf, PEZ_poly_sf, land_sf, 500)
sardist_zoom<-plot_sardist(sardist_sf, PEZ_poly_sf, land_sf, 50)
```
...
```{r echo=FALSE, results='asis'}
crithab_wide<-plot_crithab(ClippedCritHab_sf, PEZ_poly_sf, land_sf, 500)
crithab_zoom<-plot_crithab(ClippedCritHab_sf, PEZ_poly_sf, land_sf, 50)
```
