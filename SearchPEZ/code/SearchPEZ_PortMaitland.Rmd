...
This report was prepared by the MSP and PIER teams for use in planning for the potential removal of a wrecked or abandoned vessel, and to evaluate its potential use for spill incidents. A polygon surrounding the potential spill areas (Predicted Exposure Zone: PEZ) was used to search regional databases (**2002 - 2018**) and summarize species that have been recorded. Species lists generated in this synthesis is subsequently circulated to emergency responders in Maritimes Science to verify and compliment the information provided (e.g. spatial and temporal presence/absence of species in the area). 
