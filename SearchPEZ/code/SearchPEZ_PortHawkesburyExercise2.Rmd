---
title: "Oil Spill Exercise - June 25 2020"
...
marfis <- marfis[which(year(marfis$DATE_TIME1)>=minYear),]
...
marfis_freq <- aggregate(
        x = list(Records = marfis$COMMON),
      by = list(Species = marfis$COMMON
      ),
      length
      )
