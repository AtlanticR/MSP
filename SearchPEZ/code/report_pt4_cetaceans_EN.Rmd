...
wsdb_plot<-site_map(studyArea,site_sf,land50k_sf,5)+
  geom_point(data = wsdb_intersect_points, aes(x = long, y = lat, color=COMMONNAME), 
             size = 3.5)+
  theme(legend.text=element_text(size=rel(0.9)))
if(Total_number_records_WSDB > 1){print(wsdb_plot + scale_colour_manual(values=whale_col2))}
```
