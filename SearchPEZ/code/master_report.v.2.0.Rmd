...
# 
# source("N:/MSP/Projects/SearchPEZ/code/site_map.r")

# # Local Phil computer path based on project wd
# the .Rmd file sets the working directory based on where it resides
# and ignores the wd set by the .RProj file
source("site_map.r")
source("plot_wsdb.r")
