...
source("//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/code/site_map.r")
source("//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/code/plot_wsdb.r")
source("//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/code/filter_wsdb.r")
...
mspPath <- "//dcnsbiona01a/BIODataSvc/IN/MSP"
data.dir <- "//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/inputs/mar.wrangling"
dataPath <- file.path("//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/outputs",paste0(AquaSiteName,PEZversion))
setwd(dataPath)
polyPath <- "//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/inputs/polygons"
```
...
wsdbFile <- file.path("//dcnsbiona01a/BIODataSvc/IN/MSP/Projects/Aquaculture/SearchPEZ/inputs","WSDB_GLazin_AllSpecies_2018.csv")
