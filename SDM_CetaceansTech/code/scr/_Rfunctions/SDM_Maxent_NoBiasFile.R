...
SDM_Maxent_NoBiasFile<-function(SoI, season_char, biasres){
...
rasterdir <- "Shelf_Study_Area/Environmental_Layers/ASCCI_for_Maxent/"
...
model <- maxent(x = predictors, p = dat$target, removeDuplicates=TRUE,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/NoBias/No_subsample"),
...
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/NoBias/No_subsample/HSMap_cumulative_nobias_nosubsample_", SoI_out,"_", season_char, ".tif")
...
model <- maxent(x = predictors, p = subs_1km, removeDuplicates=TRUE,
                path=paste0("Output/ISO3000_SA/CC/",SoI_out,"/", season_char, "/NoBias/Subsample_1km"),
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000",
                         "betamultiplier=1"))
...
HSMap_cumulative <- scaledCumsum(HSMap)
plot(HSMap_cumulative)
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char,  "/NoBias/Subsample_1km/HSMap_cumulative_1kmsubsample_nobias_", SoI_out, "_", season_char,".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
...
model <- maxent(x = predictors, p = subs_2.5km, removeDuplicates=TRUE,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/",season_char, "/NoBias/Subsample_2.5km"),
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000",
                         "betamultiplier=1"))
...
HSMap_cumulative <- scaledCumsum(HSMap)
plot(HSMap_cumulative)
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/NoBias/Subsample_2.5km/HSMap_cumulative_2.5kmsubsmaple_nobias_", SoI_out,"_", season_char, ".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
...
model <- maxent(x = predictors, p = subs_5km, removeDuplicates=TRUE,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/NoBias/Subsample_5km"),
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000",
                         "betamultiplier=1"))
...
HSMap_cumulative <- scaledCumsum(HSMap)
plot(HSMap_cumulative)
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out,"/", season_char, "/NoBias/Subsample_5km/HSMap_cumulative_5kmsubsample_nobias_", SoI_out,"_", season_char, ".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
