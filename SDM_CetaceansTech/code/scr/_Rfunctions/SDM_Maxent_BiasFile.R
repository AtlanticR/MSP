...
SDM_Maxent_BiasFile<-function(SoI, season_char, biasres){
graphics.off()
  SoI_out<-gsub(" ", "_", SoI)
...
model <- maxent(x = predictors, p = dat$target, removeDuplicates=TRUE, a = dat$bias,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_", biasres, "/No_subsample"),
...
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_", biasres, "/No_subsample/HSMap_cumulative_bias_",biasres,"_", SoI_out, "_", season_char, ".tif")
...
model <- maxent(x = predictors, p = subs_1km, removeDuplicates=TRUE, a = dat$bias,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_",  biasres, "/Subsample_1km"),
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000",
                         "betamultiplier=1"))
...
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_1km/HSMap_cumulative_1kmsubsample_", biasres,"bias_",SoI_out, "_", season_char,   ".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
...
model <- maxent(x = predictors, p = subs_2.5km, removeDuplicates=TRUE, a = dat$bias,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_",biasres, "/Subsample_2.5km"),
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000",
                         "betamultiplier=1"))
...
HSMap_cumulative <- scaledCumsum(HSMap)
plot(HSMap_cumulative)
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_2.5km/HSMap_cumulative_2.5kmsubsample_", biasres,"bias_",SoI_out, "_", season_char,   ".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")


########## 8: 5km subsample, with bias file ################
model <- maxent(x = predictors, p = subs_5km, removeDuplicates=TRUE, a = dat$bias,
                path=paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_5km"),    
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000", 
                         "betamultiplier=1"))
...
HSMap_cumulative <- scaledCumsum(HSMap)
#plot(HSMap_cumulative)
outfile = paste0("Output/ISO3000_SA/CC/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_5km/HSMap_cumulative_5kmsubsample_", biasres,"bias_",SoI_out, "_", season_char,   ".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
