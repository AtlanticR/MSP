...
SDM_Maxent_BiasFile_Gomez<-function(SoI, season_char, biasres){
graphics.off()
  SoI_out<-gsub(" ", "_", SoI)
...
Whaling_Sightings <- read.csv("Davies/WhalingData/Whaling_Right_Whales_ScotianShelf.csv", header=TRUE, na.strings = "NA", sep=",", as.is=T, strip.white=T)
Whaling_Sightings$Species <- factor(Whaling_Sightings$Species)
Whaling_Sightings$Platform <- factor(Whaling_Sightings$Platform) # should check this with Catalina


MarMammSightings<-rbind(MarMammSightings, Whaling_Sightings)
###**************************************************************************************************##
...
rasterdir <- "Davies/Environmental_Layers/ASCII_for_MaxEnt/"
...
# #****************************** Predictor Files *******************************************
  ...
  if (season_CHAR == "AUTUMN"){
              predictorfiles_season <- predictorfiles[  predictorfiles != "chl_magn_spring.asc" &
                                     ...
                                     predictorfiles !=  "chl_pers_win_ss.asc" &
                                     predictorfiles !=  "chl_pers_aut_ss.asc" &
                                     predictorfiles !=  "chl_pers_spr_ss.asc" &
                                     predictorfiles !=  "chl_pers_sum_ss.asc" &   
                                      predictorfiles !=  "chl_pers_ann_ss.asc" &                                     
...
predictorfiles_season <- predictorfiles[predictorfiles != "chl_magn_summer.asc" &
                                  predictorfiles != "chl_magn_spring.asc" &
                                  predictorfiles != "chl_pers_spring.asc" &
                                  predictorfiles != "chl_pers_summer.asc" &
                                  predictorfiles !=  "sst_spring.asc" &
                                  predictorfiles !=  "chl_pers_win_ss.asc" &
                                  predictorfiles !=  "chl_pers_aut_ss.asc" &
                                  predictorfiles !=  "chl_pers_ann.asc"  &
                                  predictorfiles !=  "cfin_sum_bio.asc" &
                                  predictorfiles !=  "chyp_sum_bio.asc" &
                                  predictorfiles !=  "chl_pers_spr_ss.asc"&
                                  predictorfiles !=  "chl_pers_sum_ss.asc" &
                                  predictorfiles !=  "density_fin.asc" &
                                  predictorfiles !=  "salinity_fin.asc" &
                                  predictorfiles !=   "tidal_fin.asc" ]
...
StudyArea <- readOGR("Davies/Environmental_Layers/StudyArea", "StudyArea")
...
Xbounds<-c(-67.814380,-56.3211)
Ybounds<- c(41.1672,47.6)
...
#                 path=paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_", biasres, "/No_subsample"),
...
# outfile = paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_", biasres, "/No_subsample/HSMap_cumulative_bias_",biasres,"_", SoI_out, "_", season_char, ".tif")
...
#                 path=paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_",  biasres, "/Subsample_1km"),
#                 args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
#                          "randomseed", "nooutputgrids",
#                          "maximumiterations=5000",
#                          "betamultiplier=1"))
...
# outfile = paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_1km/HSMap_cumulative_1kmsubsample_", biasres,"bias_",SoI_out, "_", season_char,   ".tif")
# writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
...
model <- maxent(x = predictors, p = subs_2.5km, removeDuplicates=TRUE, a = dat$bias,
                path=paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_",biasres, "/Subsample_2.5km"),
                args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
                         "randomseed", "nooutputgrids",
                         "maximumiterations=5000",
                         "betamultiplier=1"))
...
HSMap_cumulative <- scaledCumsum(HSMap)
plot(HSMap_cumulative)
outfile = paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_2.5km/HSMap_cumulative_2.5kmsubsample_", biasres,"bias_",SoI_out, "_", season_char,   ".tif")
writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")


# ########## 8: 5km subsample, with bias file ################
# model <- maxent(x = predictors, p = subs_5km, removeDuplicates=TRUE, a = dat$bias,
#                 path=paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_5km"),    
#                 args = c("-P", "-J", "replicates=100", "replicatetype=Crossvalidate",
#                          "randomseed", "nooutputgrids",
#                          "maximumiterations=5000", 
#                          "betamultiplier=1"))
...
# HSMap_cumulative <- scaledCumsum(HSMap)
# #plot(HSMap_cumulative)
# outfile = paste0("Output/Davies/Gomez/", SoI_out, "/", season_char, "/Bias_", biasres, "/Subsample_5km/HSMap_cumulative_5kmsubsample_", biasres,"bias_",SoI_out, "_", season_char,   ".tif")
# writeRaster(HSMap_cumulative, filename=outfile, overwrite=TRUE, format="GTiff", datatype="FLT4S")
